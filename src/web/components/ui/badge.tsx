...
const variantStyles: Record<BadgeProps['variant'], string> = {
  ...
  success:
    'bg-teal-50 text-teal-700 border border-teal-200/60 hover:bg-teal-100
     dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-700/40',
  warning:
  ...
  error:
    'bg-red-50 text-red-700 border border-red-200/60 hover:bg-red-100
     dark:bg-red-900/30 dark:text-red-300 dark:border-red-700/40',
  info:
    'bg-indigo-50 text-indigo-700 border border-indigo-200/60 hover:bg-indigo-100
     dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-700/40',
  primary:
    'bg-indigo-600 text-white shadow-md hover:bg-indigo-700 transition-colors
     dark:bg-indigo-500 dark:hover:bg-indigo-400',
  secondary:
    'bg-slate-200 text-slate-800 border border-slate-300/60 hover:bg-slate-300
